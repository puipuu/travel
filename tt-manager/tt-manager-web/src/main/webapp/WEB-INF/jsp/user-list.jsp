...
<div id="toolbar">
    ...
    <div class="heading">
        ...
        <button id="btnEdit"  type="button"  class="btn btn-warning" onclick="editor()">
            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>修 改
        </button>
        ...
        sweetAlert({
            ...
            if(r) {
                ...
                $.post(
                    ...
                    '${pageContext.request.contextPath}/user/removeuser',
...
//        search: true,                      // 是否显示表格搜索，此搜索是客户端搜索，不会进服务端，所以，个人感觉意义不大
         ...
         当前行数据对象、更新前的值、编辑的当前单元格的jQuery对象。*/
            onEditableSave:function (filed,row,oldValue,$el){
                var Data={id:row.id,name:row.name,username:row.username,phone:row.phone,address:row.address}
                    debugger
