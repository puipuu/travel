...
public class FileServiceImpl implements FileService {
    ...
    public Map<String, Object> uploadImages(MultipartFile upfile) {
        ...
        String address = "120.79.155.43";
        int port = 21;
        String username = "ftpuser";
        String password = "cxq19941217";
        ...
        boolean bool = FtpUtils.uploadFile(address, port, username, password, basePath, dateString, newName, inputStream);
