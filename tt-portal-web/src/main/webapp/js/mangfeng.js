...
(function (v) {
    ...
    var g = v.M, e = v.$;
    var b = window.Env || {}, n = b.WWW_HOST || "www.mafengwo.cn", x = b.JS_HOST || "js.mafengwo.net",
    ...
    g.loadCSSJS = function (H, G) {
        ...
        if (!D.length && !E.length) {
            ...
            e.ajax({
                ...
                data: {css_list: D, js_list: E, loaded_modules: F.join(",")},
                success: function (I) {
    ...
    var C = v.document, f = C.getElementsByTagName("head")[0] || C.documentElement,
        B = +navigator.userAgent.replace(/.*AppleWebKit\/(\d+)\..*/, "$1") < 536, k = [];
    var q = function (D) {
        return D.search(/\.css(\?[^\.\?]*)?$/) !== -1
    }, u = function (H, E) {
        var G = H.sheet, D = false;
        if (B && G) {
            D = true
        } else {
            if (G) {
        ...
        if (F) {
            ...
            E.async = true;
            E.src = D;
            if (!b.disable_cors && (D.indexOf("http://" + x) === 0 || D.indexOf("https://" + x) === 0)) {
                    ...
                    if (D.data) {
                        if (g.isObject(D.data)) {
                            if (D.data._need_cstk) {
                                D.data = e.extend(D.data, {__ctk__: b.CSTK})
                            }
                        } else {
                            if (g.is(D.data, "String")) {
                                if (D.data.indexOf("_need_cstk") != -1) {
                                    D.data = D.data + "&" + e.param({__ctk__: b.CSTK})
                                }
                            }
                        }
                    }
    ...
    g.loadAppRaw = function (E, D, H, I) {
        ...
        var F = {app: E, loaded_modules: G.join(","), params: JSON.stringify(H)};
        if (D) {
            F.app_conf = D
        }
        e.ajax({
    ...
    g.loadApp = function (E, D, F, G) {
        g.loadAppRaw(E, D, F, function (H) {
            if (!g.isEmpty(H)) {
                var I = {css_list: H.css || [], js_list: H.js || []};
                y(I, function () {
    ...
    e(document).on("click", "[data-japp]", function (D) {
        ...
        if ((E.get(0).tagName.toLowerCase() == "a" && E.attr("href") == "#") || E.hasClass("_j_pvd")) {
            D.preventDefault()
        }
        A(E)
    });
    ...
    function A(K) {
        var L = K.data("japp"), D = K.data("jappconf");
        var G = g.indexOf(c, L) != -1;
        if (typeof K.data("openwindow") != "undefined") {
            G = !!K.data("openwindow")
        }
        if (G) {
            var E = K.data("windowsetting") || "width=700,height=680,left=75,top=20,scrollbars=no,status=no,resizable=no,menubar=no,toolbar=no,scrollbars=no,location=yes";
            K.data("openwindow", window.open("", K.data("openwindow"), E))
        }
        var H = K.data(), I = K.data("jappfedata"), F = {};
        ...
        if (g.isUndefined(I) || I.length > 0) {
            for (var J in H) {
                if (H.hasOwnProperty(J)) {
                    if (g.indexOf(["japp", "jappconf", "jappfedata", "openwindow"], J) == -1) {
    ...
    var h = [], a = b.pagelet_block_class || "pagelet-block",
    ...
    g.mix(m.prototype, {
        syncXHR: null, autoAbortPrevSync: true, getSyncParams: function (D) {
            return D ? this.__private_data.sync_params[D] : this.__private_data.sync_params
            ...
            if (D) {
                ...
                this.syncXHR = m.loadContent(D, this.getSyncParams(), this.container, e.proxy(function (F) {
                    this.syncHtml(F.html);
                    this.syncData(F.controller_data);
                    g.Event(this).fire("content sync success")
                }, this), e.proxy(function (F) {
    ...
    g.mix(m, {
        createInstance: function (E, D) {
            ...
            var F = new m(g.mix({
                __private_data: {sync_api: E.data("api"), sync_params: G},
                data: g.mix({}, E.data("controller_data")),
                container: E
            }, D));
            g.Event.fire("pagelet loaded", {id: E.attr("id"), pagelet: F});
            g.Event.fire("pagelet " + E.attr("id") + " loaded", {pagelet: F});
            return F
        }, createEvents: function (D, F, E) {
            g.forEach(F, function (H, G) {
                var I = typeof H == "function" ? e.proxy(H, E) : (H in E ? e.proxy(E[H], E) : null);
                if (I) {
                    var J = G.split(",");
                    if (J.length == 1) {
                        D.on(J[0], I)
            ...
            if (E.length) {
                ...
                return e.ajax({
                    dataType: "jsonp",
                    data: {params: JSON.stringify(I)},
                    url: z + "/" + H + "/" + E.join("/"),
                    success: function (N) {
                        if (N && N.data) {
                            typeof G == "function" && G(N.data)
                        } else {
                            var O = {type: "business_error", error: N && N.error || {}};
                            typeof J == "function" && J(O)
                        }
                    },
                    error: function (O, Q, P) {
                        var N = {type: "http_error", error: {xhr: O, status: Q}};
            ...
            if (D.length && D.data("async") && D.data("api")) {
                m.loadContent(D.data("api"), D.data("params"), D, function (F) {
                    y({css_list: F.css}, function () {
                        if (F.js && F.js.length) {
            ...
            var D = F.data("controller"), E = F.attr("id");
            if (D) {
    ...
    g.Pagelet = {
        ...
        }, createInstance: m.createInstance, createFromContainer: function (F, E) {
            var D = e("#" + F), H = e.trim(D.data("style")), I = H.length ? H.split(",") : [],
                J = D.data("params") || {}, G = D.data("api"), E = E || {};
            if (D.length) {
                g.fetchCSSJS(I, function () {
                    if (G) {
                        m.loadContent(G, J, D, function (K) {
                            y({css_list: K.css}, function () {
                                if (K.js && K.js.length) {
...
mfwSendLog.init = function (b, a, d) {
    ...
    this.sendByBeacon(b, a, d) || this.sendByPost(b, a, d) || this.sendByImg(b, a, d)
};
/*var mfwPageEvent = (function () {
    return function (o, j, d, l) {
        ...
        if (o && j) {
            ...
            var e = {ac: o, ec: j, u: m, r: a, ex: k, ar: d, t: p, pid: g, rn: h};
...
(function () {
    var a = {
        _getFlash: function () {
            ...
            var b = window.Env.TONGJI_HOST ? window.Env.TONGJI_HOST : "tongji.mafengwo.cn";
            var c = ("https:" == document.location.protocol ? "https://" : "http://") + b + "/stat_click.gif";
            mfwSendLog.init(c, d)
...
(function () {
    ...
    var a = {
        init: function (e) {
            ...
            a.addEvent(window, "load", a.saveResourceTime);
            a.guid = a.createGuid()
        }, save: function () {
            if (c.submitted) {
                return
...
(function () {
    ...
    var L = C.forEach, q = C.map, E = C.reduce, c = C.reduceRight, b = C.filter, B = C.every, p = C.some, n = C.indexOf,
    ...
    N.VERSION = "1.6.0";
    var I = N.each = N.forEach = function (T, Q, P) {
        if (T == null) {
            return T
        }
        if (L && T.forEach === L) {
    ...
    N.find = N.detect = function (R, P, Q) {
        var O;
        A(R, function (U, S, T) {
            if (P.call(Q, U, S, T)) {
                O = U;
    ...
    N.filter = N.select = function (R, O, Q) {
        var P = [];
        if (R == null) {
            return P
        }
    ...
    N.reject = function (Q, O, P) {
        return N.filter(Q, function (T, R, S) {
            return !O.call(P, T, R, S)
        }, P)
    };
    N.every = N.all = function (R, P, Q) {
        P || (P = N.identity);
        var O = true;
        if (R == null) {
            return O
        ...
        I(R, function (U, S, T) {
            if (!(O = O && P.call(Q, U, S, T))) {
                return D
            }
        });
        return !!O
    };
    var A = N.some = N.any = function (R, P, Q) {
        P || (P = N.identity);
        var O = false;
        if (R == null) {
            return O
    ...
    N.pluck = function (P, O) {
        return N.map(P, N.property(O))
    };
    N.where = function (P, O) {
        return N.filter(P, N.matches(O))
    };
    N.findWhere = function (P, O) {
        return N.find(P, N.matches(O))
    };
    N.max = function (S, Q, P) {
        if (!Q && N.isArray(S) && S[0] === +S[0] && S.length < 65535) {
            return Math.max.apply(Math, S)
        }
        var O = -Infinity, R = -Infinity;
        I(S, function (W, T, V) {
            var U = Q ? Q.call(P, W, T, V) : W;
            if (U > R) {
                O = W;
                R = U
            }
    ...
    N.sortBy = function (Q, P, O) {
        P = a(P);
        return N.pluck(N.map(Q, function (T, R, S) {
            return {value: T, index: R, criteria: P.call(O, T, R, S)}
        }).sort(function (U, T) {
            var S = U.criteria;
            var R = T.criteria;
            if (S !== R) {
    ...
    var t = function (O) {
        return function (S, R, Q) {
            ...
            R = a(R);
            I(S, function (V, T) {
                var U = R.call(Q, V, T, S);
                O(P, U, V)
            });
            return P
        }
    };
    N.groupBy = t(function (O, P, Q) {
        N.has(O, P) ? O[P].push(Q) : O[P] = [Q]
    });
    N.indexBy = t(function (O, P, Q) {
        O[P] = Q
    });
    N.countBy = t(function (O, P) {
        N.has(O, P) ? O[P]++ : O[P] = 1
    });
    ...
    N.bind = function (R, P) {
        var O, Q;
        if (F && R.bind === F) {
            return F.apply(R, o.call(arguments, 1))
        }
        if (!N.isFunction(R)) {
            throw new TypeError
        }
    ...
    N.extend = function (O) {
        I(o.call(arguments, 1), function (P) {
            if (P) {
                for (var Q in P) {
                    O[Q] = P[Q]
                }
    ...
    N.omit = function (Q) {
        var R = {};
        var P = y.apply(C, o.call(arguments, 1));
        for (var O in Q) {
            if (!N.contains(P, O)) {
                R[O] = Q[O]
            }
    ...
    var J = function (V, U, P, Q) {
        ...
        if (T !== R && !(N.isFunction(T) && (T instanceof T) && N.isFunction(R) && (R instanceof R)) && ("constructor" in V && "constructor" in U)) {
            return false
        }
        P.push(V);
        Q.push(U);
    ...
    I(["Arguments", "Function", "String", "Number", "Date", "RegExp"], function (O) {
        N["is" + O] = function (P) {
    ...
    N.constant = function (O) {
        return function () {
            return O
        }
    };
    N.property = function (O) {
        return function (P) {
            return P[O]
        }
    };
    N.matches = function (O) {
        return function (Q) {
            if (Q === O) {
                return true
            }
    ...
    N.each(["escape", "unescape"], function (O) {
        N[O] = function (P) {
            ...
            return ("" + P).replace(K[O], function (Q) {
                return m[O][Q]
            })
        }
    });
    ...
    N.mixin(N);
    I(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function (O) {
        var P = C[O];
    ...
    I(["concat", "join", "slice"], function (O) {
        var P = C[O];
        N.prototype[O] = function () {
    ...
    if (window && window.M && typeof window.M.define === "function") {
        M.define("/js/corelib/underscore-1.6.0", function (P, O, Q) {
            Q.exports = N
        })
    } else {
...
(function (a, b) {
    if (typeof define === "function" && define.amd) {
        define(["underscore", "jquery", "exports"], function (e, f, d) {
    ...
    O.extend(i.prototype, L, {
        interval: 50, atRoot: function () {
            ...
            var S = (K.exec(navigator.userAgent.toLowerCase()) && (!P || P <= 7));
            this.root = ("/" + this.root + "/").replace(f, "/");
            if (S && this._wantsHashChange) {
                var U = B.$('<iframe src="javascript:0" tabindex="-1">');
                this.iframe = U.hide().appendTo("body")[0].contentWindow;
                this.navigate(Q)
            }
            ...
            if (this._wantsHashChange && this._wantsPushState) {
                if (!this._hasPushState && !this.atRoot()) {
                    ...
                    if (this._hasPushState && this.atRoot() && T.hash) {
